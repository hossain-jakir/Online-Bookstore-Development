            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="dz-card style-2 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="dz-media">
                            <a href="books-detail.html"><img src="{{ asset('assets/frontend/images/blog/blog5.jpg')}}" alt="/"></a>
                        </div>
                        <div class="dz-info">
                ...
                <div class="swiper-slide">
                    <div class="dz-card style-2 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="dz-media">
                            <a href="books-detail.html"><img src="{{ asset('assets/frontend/images/blog/blog6.jpg')}}" alt="/"></a>
                        </div>
                        <div class="dz-info">
                ...
                <div class="swiper-slide">
                    <div class="dz-card style-2 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="dz-media">
                            <a href="books-detail.html"><img src="{{ asset('assets/frontend/images/blog/blog7.jpg')}}" alt="/"></a>
                        </div>
                        <div class="dz-info">
