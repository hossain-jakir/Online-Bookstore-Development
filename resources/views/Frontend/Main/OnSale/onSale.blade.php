            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="books-card style-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="dz-media">
                            <img src="{{ asset('assets/frontend/images/books/grid/book11.jpg')}}" alt="book">
                        </div>
                        <div class="dz-content">
                ...
                <div class="swiper-slide">
                    <div class="books-card style-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="dz-media">
                            <img src="{{ asset('assets/frontend/images/books/grid/book7.jpg')}}" alt="book">
                        </div>
                        <div class="dz-content">
                ...
                <div class="swiper-slide">
                    <div class="books-card style-3 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="dz-media">
                            <img src="{{ asset('assets/frontend/images/books/grid/book12.jpg')}}" alt="book">
                        </div>
                        <div class="dz-content">
                            <h5 class="title"><a href="books-grid-view.html">The Missadventure</a></h5>
                            <ul class="dz-tags">
                ...
                <div class="swiper-slide">
                    <div class="books-card style-3 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="dz-media">
                            <img src="{{ asset('assets/frontend/images/books/grid/book3.jpg')}}" alt="book">
                        </div>
                        <div class="dz-content">
