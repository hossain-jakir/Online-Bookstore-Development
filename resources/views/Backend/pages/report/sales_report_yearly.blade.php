...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Sales Report for {{ $year }}</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('backend.report.salesReport', ['year' => $year - 1]) }}" class="btn btn-primary">Previous Year</a>
                        <a href="{{ route('backend.report.salesReport', ['year' => date('Y'), 'month' => date('m')]) }}" class="btn btn-secondary">Monthly Report</a>
                        <a href="{{ route('backend.report.salesReport', ['year' => $year + 1]) }}" class="btn btn-primary">Next Year</a>
                    </div>
                </div>
            </div>
        </div>
