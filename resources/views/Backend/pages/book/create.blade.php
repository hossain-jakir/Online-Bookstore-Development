                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Fill in the Book Information</h3>
                        </div>
                        <!-- form start -->
                        <form role="form" action="{{ route('backend.book.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4" placeholder="Enter description">{{ old('description') }}</textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('author_id') is-invalid @enderror" id="author_id" name="author_id" required>
                                        ...
                                        <!-- Populate this with a list of authors from your database -->
                                        @foreach ($data['authors'] as $author)
                                            {{-- show with picture --}}
                                            <option value="{{ $author->id }}" data-img-src="{{ Storage::url($author->image) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('isbn') is-invalid @enderror" id="isbn" name="isbn" placeholder="Enter ISBN" value="{{ old('isbn') }}" required>
                                    @error('isbn')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('edition_language') is-invalid @enderror" id="edition_language" name="edition_language" placeholder="Enter edition language" value="{{ old('edition_language') }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('publisher') is-invalid @enderror" id="publisher" name="publisher" placeholder="Enter publisher" value="{{ old('publisher') }}" required>
                                    @error('publisher')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('pages') is-invalid @enderror" id="pages" name="pages" placeholder="Enter number of pages" value="{{ old('pages') }}">
                                    @error('pages')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('lessons') is-invalid @enderror" id="lessons" name="lessons" placeholder="Enter number of lessons" value="{{ old('lessons') }}">
                                    @error('lessons')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('min_age') is-invalid @enderror" id="min_age" name="min_age" placeholder="Enter minimum age" value="{{ old('min_age') }}">
                                    @error('min_age')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('purchase_price') is-invalid @enderror" id="purchase_price" name="purchase_price" placeholder="Enter purchase price" value="{{ old('purchase_price') }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('sale_price') is-invalid @enderror" id="sale_price" name="sale_price" placeholder="Enter sale price" value="{{ old('sale_price') }}" required>
                                    @error('sale_price')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('discounted_price') is-invalid @enderror" id="discounted_price" name="discounted_price" placeholder="Enter discounted price" value="{{ old('discounted_price') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('on_sale') is-invalid @enderror" id="on_sale" name="on_sale">
                                        <option value="0" {{ old('on_sale') == '0' ? 'selected' : '' }}>No</option>
